...
class SocialsControllerTest < ActionController::TestCase
  ...
  test "should create social" do
    assert_difference('Social.count') do
      post :create, social: { description: @social.description, image_uid: @social.image_uid, slave: @social.slave, title: @social.title }
    end
  ...
  test "should update social" do
    patch :update, id: @social, social: { description: @social.description, image_uid: @social.image_uid, slave: @social.slave, title: @social.title }
    assert_redirected_to social_path(assigns(:social))
  end
